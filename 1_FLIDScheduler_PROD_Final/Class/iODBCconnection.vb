...
Public Class iODBCconnection
    ...
    Public Sub OpenConnection(ByVal DBServer As String, ByVal DBUserName As String, ByVal DBPassword As String, ByVal DBName As String)
        ...
        Try
            ...
            lsConnectionString = ConfigurationManager.AppSettings("ConnectionString")
        ...
        End Try
    End Sub
    Public Sub HFCOpenConnection(ByVal DBServer As String, ByVal DBUserName As String, ByVal DBPassword As String, ByVal DBName As String)
        Dim lsConnectionString As String
    ...
    Public Function GetDataReader(ByVal SQL As String) As SqlDataReader
        ...
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "i-Alert")
            el.WriteToErrorLog(ex.Message, SQL, "GetDataReader")
        End Try
        lobjCommand.Dispose()
        lobjCommand = Nothing
    End Function
    ...
    Public Function ExecuteNonQuerySQL(ByVal SQL As String) As Object
        ...
        lobjCommand = Nothing
    End Function
    Public Function ExecuteNonQuerySP(ByVal SQL As String, ByVal Param1 As String) As Object
        Dim lobjCommand As New SqlCommand
        Try
            lobjCommand.Connection = moDbConn
            lobjCommand.CommandText = SQL
            lobjCommand.CommandType = CommandType.StoredProcedure
            lobjCommand.Parameters.Add("@Action", SqlDbType.VarChar).Value = Param1
            lobjCommand.ExecuteNonQuery()
            ExecuteNonQuerySP = ""
        Catch ex As SqlException
            ExecuteNonQuerySP = ex.Message
        End Try
        lobjCommand.Dispose()
        lobjCommand = Nothing
    End Function
