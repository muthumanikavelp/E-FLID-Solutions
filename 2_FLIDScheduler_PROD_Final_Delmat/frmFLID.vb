...
Public Class frmFLID
    ...
    Private Sub FLIDS_EMPLOYEE()
        Try
            ...
            Dim employee_iswklupdatereq As String 'ramya added for Grade change at IEM level which comes under Delmat CR on 20 Aug 22
            employee_iswklupdatereq = ""
            ...
            If loMigrationData.HasRows Then
                ...
                While loMigrationData.Read
                    ...
                    Try
                        ...
                        Try
                            If EMP_STAFFID.ToString.ToString <> "" Then
                                lsSQL = ""
                                lsSQL &= " SELECT isnull(employee_iswklupdatereq,'Y') FROM iem_mst_temployee "
                                lsSQL &= " WHERE employee_code = '" & EMP_STAFFID & "' "                     ' Mid(PRODUCTDESCRIPTION, 1, 3)

                                employee_iswklupdatereq = Val(loDBConnection.GetExecuteScalar(lsSQL).ToString)
                            End If
                        Catch ex As Exception
                            WriteLog("employee_iswklupdatereq error : " + lsSQL)
                        End Try
                    ...
                    Else
                        ...
                        ' ramya modified on 20 Aug 22 for Grade info update based on is workline update
                        If employee_iswklupdatereq.ToString = "Y" Then
