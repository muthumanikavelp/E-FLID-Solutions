...
Public Class ErrorLogger
    ...
    Public Sub WriteToErrorLog(ByVal msg As String, ByVal stkTrace As String, ByVal title As String)
        ...
        End If
        Dim strFileName As String = "ErrorLog_" & DateTime.Today.ToString("dd-MMM-yyyy") & ".txt"
        'check the file
        Dim fs As FileStream = New FileStream(Application.StartupPath & "\Errors\" + strFileName, FileMode.OpenOrCreate, FileAccess.ReadWrite)
        Dim s As StreamWriter = New StreamWriter(fs)
        s.Close()
        fs.Close()

        'log it
        Dim fs1 As FileStream = New FileStream(Application.StartupPath & "\Errors\" + strFileName, FileMode.Append, FileAccess.Write)
